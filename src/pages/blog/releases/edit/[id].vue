...
onMounted(() => {
  store.loadBookDetails(route.params.id).then(() => {
    formData.value.type = store.getBookDetails.type;
    formData.value.title_ar = store.getBookDetails.title_ar;
    formData.value.title_en = store.getBookDetails.title_en;
    formData.value.subtitle_ar = store.getBookDetails.subtitle_ar;
    formData.value.subtitle_en = store.getBookDetails.subtitle_en;
    images.value = store.getBookDetails.image
      ? [store.getBookDetails.image]
      : [];
    formData.value.file = store.getBookDetails.file
      ? [store.getBookDetails.file]
      : [];
  });
});
</script>
