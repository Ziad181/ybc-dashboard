  ...
  <div class="misc-wrapper">
    <div class="misc-center-content text-center mb-12">
      ...
      <h4 class="text-h4 font-weight-medium mb-3">
        {{ $t("common.You are not authorized!") }} 🔐
      </h4>
      <p>
        {{ $t("common.You dont have permission to access this page Go Home!") }}
      </p>
      <VBtn to="/"> {{ $t("common.Back to Home") }} </VBtn>
    </div>

    <!-- 👉 Image -->
    <div class="misc-avatar w-100 text-center">
      <!-- // <VImg // :src="page401" // alt="Coming Soon" // :max-width="170" //
      class="mx-auto" // /> -->
    </div>
