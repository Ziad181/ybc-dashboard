...
onMounted(() => {
  store.loadCategories(filteredData);
});
...
const changeStatus = (id, status) => {
  ...
  store.categoryChangeStatus(data);
...
const deleteCategoryFun = (id, status) => {
  let data = {
    id: id,
  };
      ...
      <VCol cols="12">
        <VCard :title="$t('nav.categories')">
          ...
          <VCardText>
            <VRow>
              ...
              >
                ...
                <VBtn class="px-7" :to="{ name: 'solar-energy-categories-add' }">
          ...
          <VTable class="text-no-wrap">
            ...
            <tbody>
              <tr
                v-for="(item, index) in store.getCategories"
                :key="index"
              ...
              >
                ...
                <td class="pt-2 pb-3">
                  <VChip
                    v-for="(subItem, subIndex) in item.sub_categories"
                    :key="subIndex"
                    size="small"
                    ...
                    <VMenu activator="parent">
                      <VList>
                        <VListItem
                          :title="$t('common.edit')"
                          :to="{
                            name: 'solar-energy-categories-edit-id',
                            params: { id: item.id },
                          }"
                        />
                        <VListItem
            ...
            <!-- 👉 table footer  -->
            <tfoot v-show="!store.getCategories.length">
              <tr>
          ...
          <VCardText
            v-if="store.getTotalCategories.currentPage"
          ...
          >
            ...
            <VPagination
              v-model="store.getTotalCategories.currentPage"
              size="small"
              :total-visible="5"
              :length="store.getTotalCategories.totalPages"
